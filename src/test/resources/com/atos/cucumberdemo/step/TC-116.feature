Feature: TC-116
  ...
  TC116:
  To check whether the booked itinerary reflects the correct information in line with the booking.
  ...
  No-of-adults:1
  No-of-children: 0
  Itinerary should reflect the correct information in line with the booking.

  Scenario: verify itinerary details are correct
